...
<html>
<head>
<title>Tourism | Admin Package Creation</title>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Price in RMB</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is RMB" value="<?php echo htmlentities($result->PackagePrice);?>" required>
									</div>
								</div>
