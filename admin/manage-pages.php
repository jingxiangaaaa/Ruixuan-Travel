  ...
  <div class="grid-form1">
  	       <h3>Update Page Data</h3>
  	         ...
  	         <div class="tab-content">
                  ...
                  <option value="manage-pages.php?type=Terms of Us">Terms and Condition</option>
                  <option value="manage-pages.php?type=Privacy Policy">Privacy and Policy</option>
                  <option value="manage-pages.php?type=About Us">About Us</option> 
                  <option value="manage-pages.php?type=Contact Us">Contact us</option>
                </select>
									</div>
								</div>
<div class="form-group">
